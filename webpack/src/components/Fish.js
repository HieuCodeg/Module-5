...
function Fish(){
    return (
        <div className="container-wrap">
            ...
            <p className="card_title-info">Pen By HieuCodeg</p>
            <form className="card_form">
                ...
                <div className="input">
                <input type="password" className="input_field" id="inputPassWord" required />
                <label className="input_label">Password</label>
                <span className="input_eye" onClick={handleShowPass}>
